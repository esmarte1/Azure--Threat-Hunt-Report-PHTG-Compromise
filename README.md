...
Network Isolation: The compromised virtual machine (AZwks-phtf-02) was immediately isolated from the PHTG virtual network to prevent lateral movement.

Infrastructure Blocking: The entire attacker-controlled /28 Uruguayan subnet (173.244.55.128/28) was blocked at the perimeter firewall and Azure NSGs.

Identity Containment: The compromised vmadminusername account was disabled, and all active sessions were terminated.

Attack Surface Reduction: The public IP address (74.249.82.162) was disassociated from the virtual machine, effectively closing port 3389 to the public internet.

Malware Removal & EDR Restoration: The malicious artifacts (PHTG.exe and Launch.bat) were removed. Microsoft Defender for Endpoint was restored to Active Mode, and Tenant-level Tamper Protection was enforced to prevent future unauthorized deactivation.

Policy Enforcement: A global policy was enacted requiring Multi-Factor Authentication (MFA) for all external administrative access to cloud infrastructure.
